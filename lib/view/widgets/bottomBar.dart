...
import 'package:quotes/view/widgets/tabItem.dart';
import 'package:vector_math/vector_math.dart' as vector;

class FancyTabBar extends StatefulWidget {

  final GestureTapCallback actionButton1;
  final GestureTapCallback actionButton2;
...
class _FancyTabBarState extends State<FancyTabBar> with TickerProviderStateMixin {
  ...
  IconData nextIcon = CustomIcon.iconmonstr_quote_3;
  IconData activeIcon = CustomIcon.iconmonstr_quote_3;
  ...
  void initState() {
    ...
    _positionTween = Tween<double>(begin: -0.75, end: -0.75);
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              TabItem(
                  ...
                  iconData: CustomIcon.iconmonstr_quote_3,
                  title: "Quotes",
                  callbackFunction: (){
                    setState(() {
                      nextIcon = CustomIcon.iconmonstr_quote_3;
                      currentSelected = 0;
                    });
                    widget.actionButton1();
                    _initAnimationAndStart(_positionAnimation.value, -0.75);
                  }),
